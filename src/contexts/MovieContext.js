...
class MovieContextProvider extends React.Component{
    ...
    fetchTrending = ()=>{
        fetch("https://api.themoviedb.org/3/trending/all/week?api_key=Key&language=en-US")
    ...
    fetchTopRated = ()=>{
        fetch("https://api.themoviedb.org/3/movie/top_rated?api_key=key&language=en-US")
        .then((response)=> response.json())
    ...
    fetchAction = ()=>{
        fetch("https://api.themoviedb.org/3/discover/movie?api_key=key&with_genres=28")
        .then((response)=> response.json())
        .then((data)=>this.setState({movies: data.results.length > 20 ? data.results.splice(0, 20) : data.results}))
    }
    ...
    fetchHorror = ()=>{
        fetch("https://api.themoviedb.org/3/discover/movie?api_key=key&with_genres=27")
        .then((response)=> response.json())
        .then((data)=>this.setState({movies: data.results.length > 20 ? data.results.splice(0, 20) : data.results}))
    }
    ...
    fetchRomance = ()=>{
        fetch("https://api.themoviedb.org/3/discover/movie?api_key=key&with_genres=10749")
        .then((response)=> response.json())
        .then((data)=>this.setState({movies: data.results.length > 20 ? data.results.splice(0, 20) : data.results}))
    }
    ...
    fetchMystery = ()=>{
        fetch("https://api.themoviedb.org/3/discover/movie?api_key=key&with_genres=9648")
        .then((response)=> response.json())
        .then((data)=>this.setState({movies: data.results.length > 20 ? data.results.splice(0, 20) : data.results}))
    }
    ...
    fetchSciFi = ()=>{
        fetch("https://api.themoviedb.org/3/discover/movie?api_key=key&with_genres=878")
        .then((response)=> response.json())
        .then((data)=>this.setState({movies: data.results.length > 20 ? data.results.splice(0, 20) : data.results}))
    }
    ...
    fetchWestern = ()=>{
        fetch("https://api.themoviedb.org/3/discover/movie?api_key=key&with_genres=37")
        .then((response)=> response.json())
        .then((data)=>this.setState({movies: data.results.length > 20 ? data.results.splice(0, 20) : data.results}))
    }
    ...
    fetchAnimation = ()=>{
        fetch("https://api.themoviedb.org/3/discover/movie?api_key=key&with_genres=16")
        .then((response)=> response.json())
